...
const Subcategory = ({sub}) => {
    ...
    const{_id,image,itemName,price,stockStatus,rating,processingTime,description ,subcategoryName} = sub
    ...
    return (
        <div  data-aos='zoom-in-up' className="card p-4 w-full bg-base-100 border shadow-lg">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm font-serif text-gray-600"> {description.slice(0,121)}</p>
